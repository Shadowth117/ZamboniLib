...
namespace zomboni
{
    public class BlewFish
    {
      ...
      985887462U
        ...
        {
            uint[] numArray = new uint[2] { source[0], source[1] };
            uint num1 = source[0];
            uint num2 = source[1];
            ...
            uint num3 = num1 ^ this.P[16];
            uint num4 = num2 ^ this.P[17];
            numArray[0] = num4;
            numArray[1] = num3;
            return numArray;
        }
        ...
        {
            uint[] numArray = new uint[2] { left, right };
            for (uint index = 0; index < 16U; index += 2U)
            {
                this.goRound(ref right, ref left, index);
                this.goRound(ref left, ref right, index + 1U);
            }
            left ^= this.P[16];
            right ^= this.P[17];
            numArray[0] = right;
        ...
        public uint[] decrypt(uint[] source)
        {
            ...
            uint num3 = num1 ^ this.P[1];
            uint num4 = num2 ^ this.P[0];
            numArray[0] = num4;
            numArray[1] = num3;
            return numArray;
        }
